...
VALUES
  (1, CURRENT_DATE, 55.00, 'Pago', 'Troca de óleo e filtro', 2),
  (2, CURRENT_DATE, 250.00, 'Aguardando', 'Compra de pneu', 3),
  (3, CURRENT_DATE, 75.00, 'Concluído', 'Filtro comprado em dois momentos + óleo', 3);
